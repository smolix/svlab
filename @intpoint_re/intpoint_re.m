function d = intpoint_re(a)
%INTPOINT Regression Optimizer
%
%  creates an optimizer object with all basic settings installed
%  (sigfig etc.)

% File:        @intpoint_re/intpoint_re.m
%
% Author:      Alex J. Smola
% Created:     01/18/98
% Modified:    05/08/00
...
d = class(d, 'intpoint_re');		% make it a class
%d = class(d, 'intpoint_re', intpoint);	% make it a class
%superiorto('intpoint');
